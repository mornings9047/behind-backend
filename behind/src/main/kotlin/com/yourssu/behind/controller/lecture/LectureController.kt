...
import com.yourssu.behind.service.lecture.LectureReadService
...
class LectureController @Autowired constructor(val lectureReadeService: LectureReadService,
                                               val lectureService: LectureService) {
    @ApiOperation(value = "강의목록 파일을 읽어서 DB에 저장")
    @ResponseStatus(HttpStatus.OK)
    @GetMapping("/read")
    fun lectureRead() {
        return lectureReadeService.readExcel()
    }
